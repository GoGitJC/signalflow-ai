  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <PageHeader
        ...
        description="Welcome to Verideum closed beta — connect providers, add knowledge, then verify a test call."
      />
          ...
          {step === 0 ? (
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Verideum answers inbound calls, books appointments, and gives your team a CRM dashboard.
